...
\end{verbatim}
Here {\tt mimic} converts an accidentally strict function into
a non-strict one (call-by-value to call-by-need conversion).

We can observe a finite prefix of {\tt fibs} by defining a {\tt take} function
